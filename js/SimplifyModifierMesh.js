import { Face3, Geometry } from '/three/src/Three.js';
import { BufferGeometry, Vector2, Vector3 } from 'https://threejs.org/build/three.module.js';
/*
...
function collapse(vertices, faces, u, v, preserveTexture) {
  ...
  if (preserveTexture) {
    for (i = u.faces.length - 1; i >= 0; i--) {
      var vertexOnFaceIndex = getVertexIndexOnFace(u.faces[i], u);
      u.faces[i].faceVertexUvs[vertexOnFaceIndex] = moveToThisUvsValues;
    }
  }

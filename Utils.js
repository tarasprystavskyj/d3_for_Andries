import { BufferGeometry, BufferAttribute } from "/js/newthree.module.js";
...
export const getIndexedPositions = (function() {
  ...
  return function buildIndexedPositions(geometry, precision, forceRecompute) {
    ...
    const indexBuffer = new SAB(faceCount * 3 * (largeIndexes ? 4 : 2));
...
export const toIndexed = (function() {
    ...
    for (let key in src.attributes) {
      ...
      switch (src_attribute.itemSize) {
        ...
        case 4:
          ...
          break;
        default:
          console.log("too large itemSize");
      }
  ...
  return function(src, precision) {
    prec = Math.pow(10, precision || 4);

    const geometry = new BufferGeometry();

    indexBufferGeometry(src, geometry);
